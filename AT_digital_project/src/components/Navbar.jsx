  ...
  return (
    <div className="fixed w-full bg-navbarcolor">
      ...
      <div
        ...
        } lg:hidden flex flex-col absolute bg-white text-black left-0 top-20 font-semibold text-2xl text-center pt-8 pb-4 gap-8 w-full transition-transform duration-300`}
        style={{ minHeight: menu ? '700px' : '0px', transition: 'min-height 0.3s ease-in-out' }}
      >
        <Link
          to="services"
          spy={true}
